...
public class FlightModeRadioTest extends RadioTest {
    ...
    private static String flightModePowerOffModem =
            SystemProperties.get("ro.mtk_flight_mode_power_off_md");
