    ...
    protected PduBody parseParts(ByteArrayInputStream pduDataStream) {
        ...
        for (int i = 0 ; i < count ; i++) {
            ...
            if ((null == part.getContentLocation())
                ...
                Log.i(LOG_TAG, "PduParser: parseParts: Hasn't find ContentLocation,"
                        + "so generate one.");
            ...
            if (header > TEXT_MAX) {
                ...
                switch (header) {
                    ...
                    case PduPart.P_CONTENT_ID:
                        ...
                        lastLen = length - (startPos - tempPos);
                        break;
                    /// M:Code analyze 007,add two new header fields,
                    /// they are not support for google default @{
        ...
        switch (messageType) {
            case PduHeaders.MESSAGE_TYPE_SEND_REQ:
                ...
                if (null == srContentType) {
                    Log.i(LOG_TAG, "Parse MandatoryHeader Failed: "
                            + "MESSAGE_TYPE_SEND_REQ PDU hasn't content type field");
                    return false;
                }
                ...
                if (null == srFrom) {
                    Log.i(LOG_TAG, "Parse MandatoryHeader Failed: "
                        + "MESSAGE_TYPE_SEND_REQ PDU hasn't From field");
                    return false;
                }
                ...
                if (null == srTransactionId) {
                    Log.i(LOG_TAG, "Parse MandatoryHeader Failed: "
                        + "MESSAGE_TYPE_SEND_REQ PDU hasn't Transaction-Id field");
                    return false;
                }
*/
                break;
            case PduHeaders.MESSAGE_TYPE_SEND_CONF:
                ...
                if (0 == scResponseStatus) {
                    Log.i(LOG_TAG, "Parse MandatoryHeader Failed: "
                            + "MESSAGE_TYPE_SEND_CONF PDU hasn't Response-Status field");
                    return false;
                }
                ...
                if (null == scTransactionId) {
                    Log.i(LOG_TAG, "Parse MandatoryHeader Failed: "
                            + "MESSAGE_TYPE_SEND_CONF PDU hasn't Transaction-Id field");
                    return false;
                }
            ...
            case PduHeaders.MESSAGE_TYPE_NOTIFICATION_IND:
                ...
                if (null == niContentLocation) {
                    Log.i(LOG_TAG, "Parse MandatoryHeader Failed: "
                            + "MESSAGE_TYPE_NOTIFICATION_IND PDU hasn't Content-Location field");
                    return false;
                }
                ...
                if (-1 == niExpiry) {
                    Log.i(LOG_TAG, "Parse MandatoryHeader Failed: "
                            + "MESSAGE_TYPE_NOTIFICATION_IND PDU hasn't Expiry field");
                    return false;
                }
                ...
                if (null == niMessageClass) {
                    Log.i(LOG_TAG, "Parse MandatoryHeader Failed: "
                            + "MESSAGE_TYPE_NOTIFICATION_IND PDU hasn't Message-Class field");
                    return false;
                }
                ...
                if (-1 == niMessageSize) {
                    Log.i(LOG_TAG, "Parse MandatoryHeader Failed: "
                            + "MESSAGE_TYPE_NOTIFICATION_IND PDU hasn't Message-Size field");
                    return false;
                }
                ...
                if (null == niTransactionId) {
                    Log.i(LOG_TAG, "Parse MandatoryHeader Failed: "
                            + "MESSAGE_TYPE_NOTIFICATION_IND PDU hasn't Transaction-Id field");
                    return false;
                }
            ...
            case PduHeaders.MESSAGE_TYPE_NOTIFYRESP_IND:
                ...
                if (0 == nriStatus) {
                    Log.i(LOG_TAG, "Parse MandatoryHeader Failed: "
                            + "MESSAGE_TYPE_NOTIFYRESP_IND PDU hasn't Status field");
                    return false;
                }
                ...
                if (null == nriTransactionId) {
                    Log.i(LOG_TAG, "Parse MandatoryHeader Failed: "
                            + "MESSAGE_TYPE_NOTIFYRESP_IND PDU hasn't Transaction-Id field");
                    return false;
                }
            ...
            case PduHeaders.MESSAGE_TYPE_RETRIEVE_CONF:
                ...
                if (null == rcContentType) {
                    Log.i(LOG_TAG, "Parse MandatoryHeader Failed: "
                            + "MESSAGE_TYPE_RETRIEVE_CONF PDU hasn't Content-Type field");
                    return false;
                }
                ...
                if (-1 == rcDate) {
                    Log.i(LOG_TAG, "Parse MandatoryHeader Failed: "
                            + "MESSAGE_TYPE_RETRIEVE_CONF PDU hasn't Date field");
                    return false;
                }
            ...
            case PduHeaders.MESSAGE_TYPE_DELIVERY_IND:
                ...
                if (-1 == diDate) {
                    Log.i(LOG_TAG, "Parse MandatoryHeader Failed: "
                            + "MESSAGE_TYPE_DELIVERY_IND PDU hasn't Date field");
                    return false;
                }
                ...
                if (null == diMessageId) {
                    Log.i(LOG_TAG, "Parse MandatoryHeader Failed: " +
                            "MESSAGE_TYPE_DELIVERY_IND PDU hasn't Message-Id field");
                    return false;
                }
                ...
                if (0 == diStatus) {
                    Log.i(LOG_TAG, "Parse MandatoryHeader Failed: " +
                            "MESSAGE_TYPE_DELIVERY_IND PDU hasn't Status field");
                    return false;
                }
                ...
                if (null == diTo) {
                    Log.i(LOG_TAG, "Parse MandatoryHeader Failed: " +
                            "MESSAGE_TYPE_DELIVERY_IND PDU hasn't To field");
                    return false;
                }
            ...
            case PduHeaders.MESSAGE_TYPE_ACKNOWLEDGE_IND:
                ...
                if (null == aiTransactionId) {
                    Log.i(LOG_TAG, "Parse MandatoryHeader Failed: " +
                            "MESSAGE_TYPE_ACKNOWLEDGE_IND PDU hasn't Transaction-Id field");
                    return false;
                }
            ...
            case PduHeaders.MESSAGE_TYPE_READ_ORIG_IND:
                ...
                if (-1 == roDate) {
                    Log.i(LOG_TAG, "Parse MandatoryHeader Failed: " +
                            "MESSAGE_TYPE_READ_ORIG_IND PDU hasn't Date field");
                    return false;
                }
                ...
                if (null == roFrom) {
                    Log.i(LOG_TAG, "Parse MandatoryHeader Failed: " +
                            "MESSAGE_TYPE_READ_ORIG_IND PDU hasn't From field");
                    return false;
                }
                ...
                if (null == roMessageId) {
                    Log.i(LOG_TAG, "Parse MandatoryHeader Failed: " +
                            "MESSAGE_TYPE_READ_ORIG_IND PDU hasn't Message-Id field");
                    return false;
                }
                ...
                if (0 == roReadStatus) {
                    Log.i(LOG_TAG, "Parse MandatoryHeader Failed: " +
                            "MESSAGE_TYPE_READ_ORIG_IND PDU hasn't Read-Status field");
                    return false;
                }
                ...
                if (null == roTo) {
                    Log.i(LOG_TAG, "Parse MandatoryHeader Failed: " +
                            "MESSAGE_TYPE_READ_ORIG_IND PDU hasn't To field");
                    return false;
                }
            ...
            case PduHeaders.MESSAGE_TYPE_READ_REC_IND:
                ...
                if (null == rrFrom) {
                    Log.i(LOG_TAG, "Parse MandatoryHeader Failed: " +
                            "MESSAGE_TYPE_READ_REC_IND PDU hasn't From field");
                    return false;
                }
                ...
                if (null == rrMessageId) {
                    Log.i(LOG_TAG, "Parse MandatoryHeader Failed: " +
                            "MESSAGE_TYPE_READ_REC_IND PDU hasn't Message-Id field");
                    return false;
                }
                ...
                if (0 == rrReadStatus) {
                    Log.i(LOG_TAG, "Parse MandatoryHeader Failed: " +
                            "MESSAGE_TYPE_READ_REC_IND PDU hasn't Read-Status field");
                    return false;
                }
                ...
                if (null == rrTo) {
                    Log.i(LOG_TAG, "Parse MandatoryHeader Failed: " +
                            "MESSAGE_TYPE_READ_REC_IND PDU hasn't To field");
                    return false;
                }
