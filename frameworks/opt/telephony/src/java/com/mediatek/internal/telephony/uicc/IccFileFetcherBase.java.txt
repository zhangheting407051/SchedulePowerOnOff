    ...
    protected void exchangeSimInfo() {
        ...
        while (it.hasNext()) {
            ...
            log("exchangeSimInfo key:" + key + " mEfid:" + mRq.mEfid + " mEfType:" + mRq.mEfType
                    ...
                    + mRq.mData + " mRecordNum:" + mRq.mRecordNum + " mPin2:" + mRq.mPin2);
            if (mRq.mAppType == APP_TYPE_ACTIVE) {
                mFh = mPhone.getIccCard() == null ? null :
                        mPhone.getIccCard().getIccFileHandler();
            } else {
        ...
        try {
            switch (msg.what) {
                ...
                case EVENT_LOAD_TRANSPARENT_DONE:
                    ...
                    data = (byte[]) ar.result;
                    log("EVENT_LOAD_TRANSPARENT_DONE key: " + sr.mKey + "  data: " + data);
                ...
                case EVENT_UPDATE_LINEARFIXED_DONE:
                    ...
                    sr = (IccFileRequest) ar.userObj;
                    log("EVENT_UPDATE_LINEARFIXED_DONE key: " + sr.mKey + "  data: " + sr.mData);
                    break;
                case EVENT_UPDATE_TRANSPARENT_DONE:
                    ...
                    sr = (IccFileRequest) ar.userObj;
                    log("EVENT_UPDATE_TRANSPARENT_DONE key: " + sr.mKey + "  data: " + sr.mData);
                    break;
                default:
