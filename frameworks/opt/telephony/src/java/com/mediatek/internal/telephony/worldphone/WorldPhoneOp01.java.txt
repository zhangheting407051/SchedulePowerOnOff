...
public class WorldPhoneOp01 extends Handler implements IWorldPhone {
    ...
    public WorldPhoneOp01() {
        ...
        sOperatorSpec = SystemProperties.get("persist.operator.optr", NO_OP);
            ...
            if (TelephonyIntents.ACTION_SIM_STATE_CHANGED.equals(action)) {
                ...
                if (IccCardConstants.INTENT_VALUE_ICC_IMSI.equals(simStatus)) {
                    ...
                    if (sUiccController != null) {
                        sIccRecordsInstance[slotId] =
                                sProxyPhones[slotId].getIccCard().getIccRecords();
                    } else {
                ...
                if (intent.getExtras() != null) {
                    ...
                    if (sServiceState != null) {
                        ...
                        logd("sRilVoiceRegState: " +
                            WorldPhoneUtil.regStateToString(sRilVoiceRegState) + ", " +
                            "sRilVoiceRadioTech: " +
                        ...
                        logd("sRilDataRegState: " +
                            WorldPhoneUtil.regStateToString(sRilDataRegState) + ", " +
                            "sRilDataRadioTech: " + ", " +
                ...
                int toModem = intent.getIntExtra(TelephonyIntents.EXTRA_MD_TYPE,
