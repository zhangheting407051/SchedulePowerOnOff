...
public class IccPhoneBookInterfaceManager {
                ...
                case EVENT_UPDATE_DONE:
                    ...
                    synchronized (mLock) {
                        ...
                        if (!mSuccess) {
                            ...
                            mErrorCause = IccProvider.ERROR_ICC_PROVIDER_SUCCESS;
                        }
    ...
    updateAdnRecordsInEfBySearch (int efid,
        ...
        return result == IccProvider.ERROR_ICC_PROVIDER_SUCCESS;
    }
    ...
    public synchronized int updateAdnRecordsInEfBySearchWithError(int efid,
        ...
        if (mErrorCause == IccProvider.ERROR_ICC_PROVIDER_SUCCESS) {
    ...
    private int getErrorCauseFromException(CommandException e) {
        ...
        if (e == null) {
            return IccProvider.ERROR_ICC_PROVIDER_SUCCESS;
        }
        ...
        switch (e.getCommandError()) {
            ...
            case EMAIL_NAME_TOOLONG:
                ret = IccProvider.ERROR_ICC_PROVIDER_EMAIL_TOO_LONG;
                break;
            case SNE_SIZE_LIMIT:
                ret = IccProvider.ERROR_ICC_PROVIDER_SNE_FULL;
                break;
            case SNE_NAME_TOOLONG:
                ret = IccProvider.ERROR_ICC_PROVIDER_SNE_TOO_LONG;
                break;
            default:
    ...
    public boolean isPhbReady() {
        ...
        logd("[isPhbReady] subId:" + subId + ", slotId: " + slotId
    ...
    public boolean moveContactFromGroupsToGroups(int adnIndex,
        ...
        return ((mAdnCache == null) ? false :
                mAdnCache.moveContactFromGroupsToGroups(adnIndex, fromGrpIdList, toGrpIdList));
    }
