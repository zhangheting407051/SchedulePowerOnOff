...
public class CdmaInboundSmsHandler extends InboundSmsHandler {
    ...
    // MTK-START:  Support CT auto register SMS
    ...
    protected int dispatchMessageRadioSpecific(SmsMessageBase smsb) {
        ...
        if (isBroadcastType) {
            ...
            if (cbMessage != null) {
                ...
                // Add for OMH. In OMH, RUIM defines the filtering criteria
                ...
                if (CdmaOmhSmsUtils.isOmhCard(mPhone.getSubId())) {
                    int check = CdmaOmhSmsUtils.getBcsmsCfgFromRuim(mPhone.getSubId(),
