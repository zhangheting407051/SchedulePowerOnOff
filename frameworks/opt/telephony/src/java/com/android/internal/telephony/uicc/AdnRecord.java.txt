...
public class AdnRecord implements Parcelable {
    ...
    int result = ERROR_ICC_PROVIDER_SUCCESS;
    ...
    public static final Parcelable.Creator<AdnRecord> CREATOR
        ...
        public AdnRecord createFromParcel(Parcel source) {
            ...
            AdnRecord adn = new AdnRecord(efid, recordNumber, alphaTag, number, anr, anr2, anr3,
                                          emails, grpIds);
            adn.setAasIndex(aas);
            adn.setSne(sne);
            return adn;
    ...
    public byte[] buildAdnString(int recordSize) {
        ...
        if (TextUtils.isEmpty(mNumber)) {
            ...
            result = ERROR_ICC_PROVIDER_SUCCESS;
           ...
           /** @} */
            ...
            try {
                ...
                CommandException cmdEx =
                  new CommandException(CommandException.Error.INVALID_PARAMETER);
