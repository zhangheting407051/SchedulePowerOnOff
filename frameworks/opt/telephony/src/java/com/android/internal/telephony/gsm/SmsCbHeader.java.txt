...
public class SmsCbHeader {
    ...
    boolean isEmergencyMessage() {
        ...
        if (mMessageIdentifier >= SmsCbConstants.MESSAGE_ID_PWS_FIRST_IDENTIFIER &&
                mMessageIdentifier <= SmsCbConstants.MESSAGE_ID_PWS_LAST_IDENTIFIER) {
            result = true;
        } else if (GsmCellBroadcastHandler.isCellAreaInTw() &&
                // Taiwan PWS - Emergency message in Chinese and in English
                (mMessageIdentifier == SmsCbConstants.MESSAGE_ID_GSMA_ALLOCATED_CHANNEL_911
                || mMessageIdentifier == SmsCbConstants.MESSAGE_ID_GSMA_ALLOCATED_CHANNEL_919)) {
            result = true;
        }
    ...
    private int getCmasMessageClass() {
        switch (mMessageIdentifier) {
            ...
            // For TWN PWS
            // 911 and 919 should be special CMAS message.
