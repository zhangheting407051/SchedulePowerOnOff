...
public abstract class CallTracker extends Handler {
    ...
    */
    ...
    protected static final int EVENT_CDMA_CALL_ACCEPTED            = EVENT_MTK_BASE + 5;
    /// @}

    /// M: CC: Vzw ECC/hVoLTE redial
    protected static final int EVENT_CALL_REDIAL_STATE             = EVENT_MTK_BASE + 6;
    ...
    public static RedialState
    redialStateFromInt(int state) {
        switch(state) {
            case 0: return RedialState.REDIAL_NONE;
            case 1: return RedialState.REDIAL_TO_MD1;
            case 2: return RedialState.REDIAL_TO_MD3;
            case 3: return RedialState.REDIAL_CHANGE_GLOBAL_MODE;
            default:
    ...
    protected void notifySrvccState(Call.SrvccState state, ArrayList<Connection> c) {
        if (state == Call.SrvccState.STARTED && c != null) {
            ...
            /// M: ALPS02019630. For IMS conference SRVCC. ECONFSRVCC is only for conference
            /// host side. @{
