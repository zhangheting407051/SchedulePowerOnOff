...
// MTK-START: Support SMS Plus Code Plug-in
...
public class SmsMessage extends SmsMessageBase {
    ...
    */
    ...
    private void parsePduFromEfRecord(byte[] pdu) {
        ...
        // MTK-START: Support SMS Plus Code Plug-in
        // We convert the plus code into IDD when save the text message to
        // RUIM, so we restore the IDD to plus code at here.
        replaceIddNddWithPluscode(addr);
        // MTK-END

        // link the filled objects to this SMS
        mOriginatingAddress = addr;
        // MTK-START: Support SmsMessageBase.getDestinationAddress
    ...
    public void parseSms() {
        ...
        */
        ...
        // MTK-START: Support to save the submit message to card.
        /*
    ...
    private static void replaceIddNddWithPluscode(CdmaSmsAddress addr) {
        ISmsPlusCodeFwkExt smsPlusCodeFwkExt = MPlugin.createInstance(
            ISmsPlusCodeFwkExt.class.getName());
        if (smsPlusCodeFwkExt != null) {
            if (smsPlusCodeFwkExt.replaceIddNddWithPluscode(addr)) {
    ...
    public static SubmitPdu createEfPdu(String destinationAddress, String message,
        ...
        */
        ...
        if (timeStamp > 0) {
            ...
            Log.d(LOG_TAG, "createEfPdu, input timeStamp = " + timeStamp
     ...
     * @return byte stream for SubmitPdu.
     */
    private static SubmitPdu privateGetPduWithTimeStamp(String destAddrStr,
