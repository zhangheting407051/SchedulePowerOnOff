...
public abstract class IccRecords extends Handler implements IccConstants {
    ...
    protected int mSubId = -1;   // Only use for broadcastPhbStateChangedIntent().
    /* M: PHB Revise
    ...
    */
    public static final int GSM_PHB_NOT_READY     = 0; // 00
    public static final int GSM_PHB_READY         = 1; // 01
    public static final int C2K_PHB_NOT_READY     = 2; // 10
    public static final int C2K_PHB_READY         = 3; // 11
    // MTK-END
        ...
        switch (msg.what) {
            ...
            case EVENT_PHB_READY:
                ...
                if (ar != null && ar.exception == null && ar.result != null) {
                    ...
                    if (DBG)
                        log("isPhbReady=" + isPhbReady[0] + ",strCurSimState = " + strCurSimState
    ...
    */
    ...
    protected abstract void updatePHBStatus(int status, boolean isSimLocked);
    // PHB Refactoring -----
    // FDN support start
