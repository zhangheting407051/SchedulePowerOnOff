...
public abstract class IccFileHandler extends Handler implements IccConstants {
    ...
    public void handleMessage(Message msg) {
        ...
        try {
            ...
            case EVENT_GET_BINARY_SIZE_DONE_EX:
                ar = (AsyncResult) msg.obj;
                LoadTransparentContext tc = (LoadTransparentContext) ar.userObj;
                result = (IccIoResult) ar.result;
                ...
                mCi.iccIOForApp(COMMAND_READ_BINARY, tc.mEfid, path, 0, 0, size, null, null, mAid,
                        obtainMessage(EVENT_READ_BINARY_DONE, tc.mEfid, 0, response));
            break;
            // MTK-END
    ...
    public void loadEFTransparent(int fileid, String path, Message onLoaded) {
        ...
        Message response = obtainMessage(EVENT_GET_BINARY_SIZE_DONE_EX,
                new LoadTransparentContext(fileid, efPath, onLoaded));
