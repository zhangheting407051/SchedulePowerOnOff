...
public class CdmaSMSDispatcher extends SMSDispatcher {
    ...
    public void sendData(String destAddr, String scAddr, int destPort,
        ...
        // MTK-START: Support OMH
        // See CDG Document 167 D60-55
        if (CdmaOmhSmsUtils.isOmhCard(mPhone.getSubId())) {
            CdmaOmhSmsUtils.getNextMessageId(mPhone.getSubId());
        }
        // MTK-END
    ...
    protected void sendSubmitPdu(SmsTracker tracker) {
        // MTK-START: get the telephony system property by phone id
        /*
    ...
    public void sendSms(SmsTracker tracker) {
        // MTK-START: Support SmsTracker Queue
    ...
    protected void sendTextWithEncodingType(String destAddr, String scAddr, String text,
        ...
        if (encoding == android.telephony.SmsMessage.ENCODING_UNKNOWN) {
            ...
            TextEncodingDetails details = SmsMessage.calculateLength(text, false, encoding);
