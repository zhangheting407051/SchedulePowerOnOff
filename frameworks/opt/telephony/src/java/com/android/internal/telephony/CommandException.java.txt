...
public class CommandException extends RuntimeException {
    ...
    fromRilErrno(int ril_errno) {
        switch(ril_errno) {
            ...
            case RILConstants.SNE_SIZE_LIMIT:
                return new CommandException(Error.SNE_SIZE_LIMIT);
            case RILConstants.SNE_NAME_TOOLONG:
                return new CommandException(Error.SNE_NAME_TOOLONG);
