...
// MTK-START: use NITZ tone to replace timezone in settings
...
public final class BearerData {
        ...
        throws CodingException
    {
        ...
        if (uData.msgEncodingSet) {
            ...
            // MTK-START
            // Support 7BIT_ASCII encoding type when has user data header.
            } else if (uData.msgEncoding == UserData.ENCODING_7BIT_ASCII) {
                encode7bitAsciiEms(uData, headerData, true);
            // Support OCTET encoding type when has user data header.
    ...
    public static byte[] encode(BearerData bData) {
        ...
        try {
            ...
            // MTK-START: AOSP's MT message PDU can't be wrote to RUIM directly,
    ...
    // MTK-START
    /**
     * Support encode Ems with the octet encoding.
    ...
    /**
     * Get time zone id from NITZ.
     *
     * @return the time zone ID
     */
    private static String getZoneId() {
        String id = SystemProperties.get(IPlusCodeUtils.PROPERTY_NITZ_TIME_ZONE_ID, "");
        if (id.equals("")) {
