...
class BipChannelManager {
    ...
    public int acquireChannelId(int protocolType) {
        byte i = 0;
        CatLog.d("[BIP]", "acquireChannelId, protocolType " + protocolType
    ...
    public void releaseChannelId(int cId, int protocolType) {
        ...
        try {
            ...
            if (BipUtils.TRANSPORT_PROTOCOL_SERVER == protocolType
                ...
                CatLog.e("[BIP]", "releaseChannelId, bad parameters.cId:"
                        + cId + ":" + mChannelIdPool);
            }
            ...
            CatLog.e("[BIP]", "IndexOutOfBoundsException releaseChannelId cId="
                    + cId + ":" + mChannelIdPool);
        }
    }
