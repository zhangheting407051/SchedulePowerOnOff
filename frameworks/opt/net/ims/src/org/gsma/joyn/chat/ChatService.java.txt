...
public class ChatService extends JoynService {
     ...
     * @throws JoynContactFormatException
     */
    public ExtendChat openSingleChat(String contact, ExtendChatListener listener)
            throws JoynServiceException, JoynContactFormatException {
        Logger.i(TAG, "openSingleChat entry " + contact);
        if (api != null) {
            try {
                IExtendChat chatIntf = api.openSingleChatEx(contact, listener);
                if (chatIntf != null) {
     ...
     * @throws JoynContactFormatException
     */
    public ExtendChat openSecondaryDeviceChat(ExtendChatListener listener)
            throws JoynServiceException, JoynContactFormatException {
        Logger.i(TAG, "openSecondaryDeviceChat entry ");
        if (api != null) {
            try {
                IExtendChat chatIntf = api.openSecondaryDeviceChat(listener);
                if (chatIntf != null) {
                    return new ExtendChat(chatIntf);
                } else {
                    return null;
    ...
    /**
     * Open a 1-Multi chat with a list of contacts and returns a ExtendChat instance.
     ...
     * @throws JoynContactFormatException
     */
    public ExtendChat openMultipleChat(List<String> contacts, ExtendChatListener listener)
            throws JoynServiceException, JoynContactFormatException {
        Logger.i(TAG, "openChat entry " + contacts);
        if (api != null) {
            try {
                IExtendChat chatIntf = api.openMultipleChat(contacts, listener);
                if (chatIntf != null) {
                    return new ExtendChat(chatIntf);
                } else {
                    return null;
     ...
     * @throws JoynContactFormatException
     */
    public GroupChat initiateGroupChat(
            Set<String> contacts, String subject, GroupChatListener listener)
            throws JoynServiceException, JoynContactFormatException {
        Logger.i(TAG, "initiateGroupChat entry= " + contacts + " subject =" + subject);
        if (api != null) {
            try {
                IGroupChat chatIntf = api.initiateGroupChat(
                        new ArrayList<String>(contacts), subject, listener);
                if (chatIntf != null) {
	 ...
	 * @throws JoynContactFormatException
     */
    public GroupChat initiateClosedGroupChat(Set<String> contacts, String subject, GroupChatListener listener) throws JoynServiceException, JoynContactFormatException {
    	Logger.i(TAG, "initiateClosedGroupChat entry= " + contacts + " subject =" + subject );
    	if (api != null) {
			try {
				IGroupChat chatIntf = api.initiateClosedGroupChat(new ArrayList<String>(contacts), subject, listener);
				if (chatIntf != null) {
					return new GroupChat(chatIntf);
				} else {
					return null;
    ...
    public ExtendChat getExtendChat(String contact) throws JoynServiceException {
        ...
        if (api != null) {
            try {
                IExtendChat chatIntf = api.getExtendChat(contact);
                if (chatIntf != null) {
                    return new ExtendChat(chatIntf);
                } else {
                    return null;
    ...
    public ExtendChat getExtendChatForSecondaryDevice() throws JoynServiceException {
        ...
        if (api != null) {
            try {
                IExtendChat chatIntf = api.getChatForSecondaryDevice();
                if (chatIntf != null) {
                    return new ExtendChat(chatIntf);
                } else {
                    return null;
