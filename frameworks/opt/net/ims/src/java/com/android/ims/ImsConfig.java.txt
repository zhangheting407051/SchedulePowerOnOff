...
public class ImsConfig {
    ...
    */
    public static class ConfigConstants {
        ...
        public static final int PROVISIONED_CONFIG_END = EPDG_ADDRESS;
    ...
    */
    ...
    public boolean getVtProvisioned() throws ImsException {
        try {
            return miConfig.getVtProvisioned();
        } catch (RemoteException e) {
            throw new ImsException("getVtProvisioned()", e,
                    ImsReasonInfo.CODE_LOCAL_SERVICE_UNAVAILABLE);
        }
    }
     ...
     * This should be the same as the operator provisioned value if applies.
     * @throws ImsException if calling the IMS service results in a error.
     *
     * @return boolean
     */
    public boolean getWfcProvisioned() throws ImsException {
        try {
            return miConfig.getWfcProvisioned();
        } catch (RemoteException e) {
            throw new ImsException("getWfcProvisioned()", e,
                    ImsReasonInfo.CODE_LOCAL_SERVICE_UNAVAILABLE);
        }
    }
