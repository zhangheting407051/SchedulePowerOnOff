...
void BufferQueueDump::parseDownSampleConfig(const char* str) {
    ...
    char *numberSignX = strstr(str, "*X");
    char *numberSignY = strstr(str, "*Y");
    char *numberSignR = strstr(str, "*R");
    char *numberSignT = strstr(str, "*T");
    char *numberSignL = strstr(str, "*L");
    char *numberSignB = strstr(str, "*B");
