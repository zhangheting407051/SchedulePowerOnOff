...
#ifdef MTK_CROSSMOUNT_SUPPORT
            ALOGV("s %d avaDev 0x%x ba2dpo %d dev 0x%x  CM-spk %d CM-mic %d sfu [0]:%d [1]:%d [4]:%d", strategy, availableOutputDevicesType,
...
#else
            ALOGV("s %d avaDev 0x%x ba2dpo %d dev 0x%x sfu [0]:%d [1]:%d [4]:%d", strategy, availableOutputDevicesType,
...
#ifdef MTK_AUDIO
    ALOGV("getDeviceForInputSource()input source %d, device %08x sfu [0]:%d [2]:%d", inputSource, device,
