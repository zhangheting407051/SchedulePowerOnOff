...
public:
    ...
    ~AudioMTKSurroundDownMix();
    status_t Init(void* trackName, int sessionID, int channelMask, int sampleRate);
    ...
    status_t SetBesSurroundMode(uint32_t value);
    status_t DownMix_Init(void* trackName, int sessionID, int channelMask, int sampleRate);
    ...
    int mDownmixRamp; // rampdown 0, normal 1, rampup 2
    int* mTempBuf;
    ...
    public:
        ...
        status_t BesSurround_SetMode(uint32_t value);
