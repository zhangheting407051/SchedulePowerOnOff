...
const char * const AudioParameter::keyBesaudenOnOff = AUDIO_PARAMETER_KEY_BESAUDEN_ONOFF;
...
const char * const AudioParameter::keyOffloadAudioCheckSupport = AUDIO_PARAMETER_KEY_OFFLOAD_AUDIO_CHECK_SUPPORT;
