...
bool ANetworkSession::Session::isClientConnected() const {
    return mClientConnected;
}

void ANetworkSession::Session::setClientConnected(bool bConnected) {
    mClientConnected = bConnected;
}

void ANetworkSession::Session::setSharedSocket(bool bShared) {
...
int ANetworkSession::findListeningSock(int port) {
