...
void dumpDecoderOut(void *inBuffer, int32_t size);
#endif
#endif
...
#ifdef MTK_AOSP_ENHANCEMENT
#ifdef DUMP_DECODER
                dumpDecoderOut(tmpOutBuffer, mStreamInfo->frameSize * sizeof(int16_t) * mStreamInfo->numChannels);
#endif
#endif
...
void dumpDecoderOut(void *inBuffer, int32_t size) {
    FILE *fpout = fopen("/sdcard/aacdecoder_out.pcm", "ab");
    if (fpout) {
